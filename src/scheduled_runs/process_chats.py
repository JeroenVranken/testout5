...
def helper_container_client(credential, environment: str):
    ...
    name_storage = os.environ["STORAGE_ACCOUNT"] if environment == "prd" else os.environ["STORAGE_ACCOUNT_DEV"]
...
if __name__ == "__main__":
    ...
    if os.environ["ENVIRONMENT"] == "prd":
        ...
        mention_users_str = os.environ.get("KLANTENSERVICE_CHAT_REPORTING_MENTION_USERS", "")
