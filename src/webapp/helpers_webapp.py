...
def chat_llm():
    ...
    return AzureChatOpenAI(
        ...
        azure_endpoint=os.environ.get("OPENAI_SWEDEN_ENDPOINT"),
        openai_api_key=os.environ.get("OPENAI_SWEDEN"),
...
def container_client() -> ContainerClient:
    ...
    if ENVIRONMENT == "prd":
        name_storage = os.environ.get("STORAGE_ACCOUNT")
    else:
        name_storage = os.environ.get("STORAGE_ACCOUNT_DEV")
